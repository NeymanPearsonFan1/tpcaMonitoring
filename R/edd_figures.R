...
#' the results/ and thresholds/ directories from https://github.com/NeyamanPearsonFan1/tpcaMonitoring
...
#' your must either have run \code{run_simstudy} yourself, or have downloaded
#' the results/ and thresholds/ directories from https://github.com/NeymanPearsonFan1/tpcaMonitoring
#' and put them in your working directory.
#'
